  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-1 bg-gray-50">
        ...
        >
          <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm max-w-[90%] sm:max-w-6xl mx-auto flex flex-col lg:flex-row gap-6 lg:gap-12">
            {/* Left: Contact Form */}
            ...
            <div className="w-full lg:w-1/3 space-y-4 sm:space-y-6">
              ...
              <div className="flex items-start space-x-3 sm:space-x-4">
                <Phone className="text-blue-600 w-4 sm:w-5 h-4 sm:h-5 mt-1" />
                <div>
              ...
              <div className="flex items-start space-x-3 sm:space-x-4">
                <Mail className="text-blue-600 w-4 sm:w-5 h-4 sm:h-5 mt-1" />
                <div>
              ...
              <div className="flex items-start space-x-3 sm:space-x-4">
                <MapPin className="text-blue-600 w-4 sm:w-5 h-4 sm:h-5 mt-1" />
                <div>
              ...
              <div className="flex items-start space-x-3 sm:space-x-4">
                <Clock className="text-blue-600 w-4 sm:w-5 h-4 sm:h-5 mt-1" />
                <div>
                  <h4 className="font-semibold text-sm sm:text-base">
                    Working Hours
                  </h4>
                  <p className="text-xs sm:text-sm text-gray-600">24/7</p>
                </div>
              </div>
            </div>
          </div>
